...
try:
    from BUNK3R_IA.core.ai_service import AIService, get_ai_service
except ImportError:
    AIService = None
    get_ai_service = None

try:
    from BUNK3R_IA.core.smart_retry import SmartRetrySystem, RetryConfig, RetryStrategy
except ImportError:
...
try:
    from BUNK3R_IA.core.output_verifier import OutputVerifier
except ImportError:
    OutputVerifier = None
