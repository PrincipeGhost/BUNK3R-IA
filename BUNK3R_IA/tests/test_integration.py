...
from BUNK3R_IA.core.ai_constructor import (
    IntentParser, TaskType, ProgrammingLanguage, IntentAnalysis,
    ResearchResult, ExecutionPlan, TaskItem, VerificationResult,
    ConstructorSession
)
from BUNK3R_IA.core.smart_retry import SmartRetrySystem, RetryConfig
from BUNK3R_IA.core.output_verifier import OutputVerifier, CodeLanguage
