...
from BUNK3R_IA.models import db, OAuth, User
...
def make_replit_blueprint():
    try:
        ...
        # Fallback for local development or if REPL_ID is missing
        repl_id = "local-dev"
    ...
    def logout():
        if hasattr(g, "flask_dance_replit"):
            del replit_bp.token
        logout_user()
