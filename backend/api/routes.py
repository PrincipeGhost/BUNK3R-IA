"""
backend.api Routes - Rutas de la API de IA
...
def get_db_manager():
    ...
    from core.ai_service import db_manager
    return db_manager
...
def get_ai_constructor():
    ...
    from core.legacy_v1_archive.ai_constructor import AIConstructorService
...
def ai_toolkit_read_file():
    ...
    try:
        from core.legacy_v1_archive.ai_toolkit import AIFileToolkit
        data = request.json
        path = data.get('path', '')
...
def ai_toolkit_run_command():
    ...
    try:
        from core.legacy_v1_archive.ai_toolkit import AICommandExecutor
        data = request.json
...
def ai_toolkit_detect_errors():
    ...
    try:
        from core.legacy_v1_archive.ai_toolkit import AIErrorDetector
        data = request.json
        logs = data.get('logs', [])
...
def ai_toolkit_analyze_project():
    ...
    try:
        from core.legacy_v1_archive.ai_toolkit import AIProjectAnalyzer
...
def ai_core_process_message():
    ...
    try:
        from core.legacy_v1_archive.ai_core_engine import AICoreOrchestrator
...
def ai_core_classify_intent():
    ...
    try:
        from core.legacy_v1_archive.ai_core_engine import AIDecisionEngine
...
def ai_core_decide_workflow():
    ...
    try:
        from core.legacy_v1_archive.ai_core_engine import AIDecisionEngine, IntentType, Intent
...
def ai_core_validate_action():
    ...
    try:
        from core.ai_core_engine import PreExecutionValidator
...
def ai_core_create_checkpoint():
    ...
    try:
        from core.ai_core_engine import RollbackManager
...
def ai_core_analyze_impact():
    ...
    try:
        from core.ai_core_engine import ChangeImpactAnalyzer
...
def ai_core_workflow_status():
    ...
    try:
        from core.ai_core_engine import WorkflowManager
...
def ai_core_create_tasks():
    """Create a task list"""
    try:
        from core.ai_core_engine import TaskManager
...
def ai_verify_code():
    ...
    try:
        from core.output_verifier import output_verifier
...
def ai_clarification_detect():
    ...
    try:
        from core.clarification_manager import clarification_manager
...
def ai_plan_create():
    ...
    try:
        from core.plan_presenter import plan_presenter
        import uuid
...
def ai_retry_stats():
    ...
    try:
        from core.smart_retry import smart_retry
...
def ai_validator_validate():
    ...
    try:
        from core.pre_execution_validator import pre_execution_validator, ActionType
...
def ai_validator_dependencies():
    ...
    try:
        from core.pre_execution_validator import pre_execution_validator
...
def ai_constructor_generate():
    ...
    try:
        from core.live_preview import live_preview
...
def ai_llm_execute_phase():
    ...
    try:
        from core.llm_phase_integrator import llm_integrator, ConstructorPhase
...
def ai_llm_run_pipeline():
    ...
    try:
        from core.llm_phase_integrator import llm_integrator
...
def ai_llm_list_phases():
    ...
    try:
        from core.llm_phase_integrator import ConstructorPhase
...
def ai_search_query():
    ...
    try:
        from core.web_search_service import web_search_service, SearchType, ContentFilter
...
def ai_search_code_examples():
    ...
    try:
        from core.web_search_service import web_search_service, ContentFilter
...
def ai_search_stats():
    ...
    try:
        from core.web_search_service import web_search_service
