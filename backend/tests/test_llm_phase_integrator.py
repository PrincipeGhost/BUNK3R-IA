...
from core.llm_phase_integrator import (
...
class TestLLMPhaseIntegrator:
    ...
    def integrator(self, mock_ai_service):
        ...
        with patch('core.llm_phase_integrator.get_ai_service', return_value=mock_ai_service):
...
class TestLLMPhaseIntegratorNoService:
    ...
    def test_integrator_without_service(self):
        ...
        with patch('core.llm_phase_integrator.get_ai_service', return_value=None):
            with patch('core.llm_phase_integrator.AIService', None):
