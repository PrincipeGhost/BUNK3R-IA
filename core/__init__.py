...
legacy_modules = [
    ...
    'clarification_manager', 'graph', 'llm_phase_integrator', 'memory',
    'monitor', 'output_verifier', 'plan_presenter', 'pre_execution_validator',
    'preferences', 'smart_retry', 'streaming_service'
]

for mod in legacy_modules:
    old_path = f"core.{mod}"
    new_path = f"core.legacy_v1_archive.{mod}"
