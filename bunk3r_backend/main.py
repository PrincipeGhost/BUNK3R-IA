...
from bunk3r_backend.config import get_config
from bunk3r_api.routes import ai_bp, set_db_manager
from bunk3r_api.project_routes import projects_bp
from bunk3r_api.github_routes import github_api_bp
from bunk3r_api.automation_routes import automation_bp
from bunk3r_api.terminal_routes import terminal_bp
from bunk3r_api.repo_manager import repo_mgr_bp
from bunk3r_api.preview_routes import preview_bp
from bunk3r_api.extension_routes import extension_bp
from bunk3r_api.ide_routes import ide_bp
from bunk3r_api.github_sync_routes import github_sync_bp
from bunk3r_backend.models import db
from bunk3r_backend.replit_auth import login_manager, require_login
...
def create_app(config_class=None):
    ...
    from bunk3r_core.gravity_core import gravity_core
    ...
    # GitHub Auth setup
    from bunk3r_backend.replit_auth import setup_github_auth
    ...
    def quick_login():
        ...
        from bunk3r_backend.models import User
        import uuid
    ...
    def serve_preview(session_id):
        ...
        from bunk3r_core.legacy_v1_archive.live_preview import live_preview
...
def init_database(database_url=None):
    ...
    from bunk3r_api.routes import set_db_manager
    ...
    try:
        from bunk3r_core.legacy_v1_archive.database.manager import manager as sqlite_manager
