...
class TestStreamEvent:
    ...
    def test_stream_event_creation(self):
        ...
        from bunk3r_core.streaming_service import StreamEvent, StreamEventType
    ...
    def test_stream_event_types(self):
        ...
        from bunk3r_core.streaming_service import StreamEventType
...
class TestStreamingService:
    ...
    def test_streaming_service_init(self):
        ...
        from bunk3r_core.streaming_service import StreamingService
...
class TestGroqStreamingProvider:
    ...
    def test_provider_init(self):
        ...
        from bunk3r_core.streaming_service import GroqStreamingProvider
...
class TestGeminiStreamingProvider:
    ...
    def test_provider_init(self):
        """Test inicialización del proveedor"""
        from bunk3r_core.streaming_service import GeminiStreamingProvider
...
class TestDeepSeekStreamingProvider:
    ...
    def test_provider_init(self):
        """Test inicialización del proveedor"""
        from bunk3r_core.streaming_service import DeepSeekStreamingProvider
...
class TestCerebrasStreamingProvider:
    ...
    def test_provider_init(self):
        """Test inicialización del proveedor"""
        from bunk3r_core.streaming_service import CerebrasStreamingProvider
...
class TestStreamChatGenerator:
    ...
    def test_stream_chat_no_providers(self):
        ...
        from bunk3r_core.streaming_service import StreamingService, StreamEventType
