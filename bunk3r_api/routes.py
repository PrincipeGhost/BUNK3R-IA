...
def get_db_manager():
    ...
    from bunk3r_core.ai_service import db_manager
    return db_manager

def set_db_manager(manager):
    """Set database manager"""
    import bunk3r_core.ai_service as ai_service_module
...
def get_ai_constructor():
    ...
    from bunk3r_core.legacy_v1_archive.ai_constructor import AIConstructorService
...
def register_brain():
    ...
    try:
        ...
        try:
            from bunk3r_backend.models import GlobalSetting
...
def ai_constructor_flow():
    ...
    try:
        from bunk3r_core.legacy_v1_archive.ai_flow_logger import flow_logger
        user_id = request.args.get('user_id', 'anonymous')
...
def ai_toolkit_read_file():
    ...
    try:
        from bunk3r_core.legacy_v1_archive.ai_toolkit import AIFileToolkit
        data = request.json
        path = data.get('path', '')
...
def ai_toolkit_run_command():
    ...
    try:
        from bunk3r_core.legacy_v1_archive.ai_toolkit import AICommandExecutor
        data = request.json
...
def ai_toolkit_detect_errors():
    ...
    try:
        from bunk3r_core.legacy_v1_archive.ai_toolkit import AIErrorDetector
        data = request.json
        logs = data.get('logs', [])
...
def ai_toolkit_analyze_project():
    ...
    try:
        from bunk3r_core.legacy_v1_archive.ai_toolkit import AIProjectAnalyzer
...
def ai_core_process_message():
    ...
    try:
        from bunk3r_core.legacy_v1_archive.ai_core_engine import AICoreOrchestrator
...
def ai_core_classify_intent():
    ...
    try:
        from bunk3r_core.legacy_v1_archive.ai_core_engine import AIDecisionEngine
...
def ai_core_decide_workflow():
    ...
    try:
        from bunk3r_core.legacy_v1_archive.ai_core_engine import AIDecisionEngine, IntentType, Intent
...
def ai_core_validate_action():
    ...
    try:
        from bunk3r_core.ai_core_engine import PreExecutionValidator
...
def ai_core_create_checkpoint():
    ...
    try:
        from bunk3r_core.ai_core_engine import RollbackManager
...
def ai_core_analyze_impact():
    ...
    try:
        from bunk3r_core.ai_core_engine import ChangeImpactAnalyzer
...
def ai_core_workflow_status():
    ...
    try:
        from bunk3r_core.ai_core_engine import WorkflowManager
...
def ai_core_create_tasks():
    """Create a task list"""
    try:
        from bunk3r_core.ai_core_engine import TaskManager
...
def ai_verify_code():
    ...
    try:
        from bunk3r_core.output_verifier import output_verifier
...
def ai_clarification_detect():
    ...
    try:
        from bunk3r_core.clarification_manager import clarification_manager
...
def ai_plan_create():
    ...
    try:
        from bunk3r_core.plan_presenter import plan_presenter
        import uuid
...
def ai_retry_stats():
    ...
    try:
        from bunk3r_core.smart_retry import smart_retry
...
def ai_validator_validate():
    ...
    try:
        from bunk3r_core.pre_execution_validator import pre_execution_validator, ActionType
...
def ai_validator_dependencies():
    ...
    try:
        from bunk3r_core.pre_execution_validator import pre_execution_validator
...
def ai_constructor_generate():
    ...
    try:
        from bunk3r_core.live_preview import live_preview
...
def ai_llm_execute_phase():
    ...
    try:
        from bunk3r_core.llm_phase_integrator import llm_integrator, ConstructorPhase
...
def ai_llm_run_pipeline():
    ...
    try:
        from bunk3r_core.llm_phase_integrator import llm_integrator
...
def ai_llm_list_phases():
    ...
    try:
        from bunk3r_core.llm_phase_integrator import ConstructorPhase
...
def ai_chat_stream():
    ...
    try:
        from bunk3r_core.streaming_service import get_streaming_service
...
def ai_search_query():
    ...
    try:
        from bunk3r_core.web_search_service import web_search_service, SearchType, ContentFilter
...
def ai_search_code_examples():
    ...
    try:
        from bunk3r_core.web_search_service import web_search_service, ContentFilter
...
def ai_search_stats():
    ...
    try:
        from bunk3r_core.web_search_service import web_search_service
