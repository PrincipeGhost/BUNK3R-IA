...
try:
    from bunk3r_core.ai_flow_logger import flow_logger
except ImportError:
    flow_logger = None

try:
    from bunk3r_core.ai_toolkit import AIFileToolkit, AICommandExecutor, AIErrorDetector, AIProjectAnalyzer
